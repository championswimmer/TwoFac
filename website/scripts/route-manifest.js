...
export const INDEXABLE_STATIC_ROUTES = [
  ...
  { path: '/compare/aegis-authenticator', changefreq: 'monthly', priority: '0.7' },
  { path: '/compare/bitwarden', changefreq: 'monthly', priority: '0.7' },
  { path: '/compare/proton-authenticator', changefreq: 'monthly', priority: '0.7' },
  { path: '/compare/ente-auth-vs-2fas-vs-twofac', changefreq: 'monthly', priority: '0.7' },
  { path: '/compare/ente-auth-vs-proton-authenticator-vs-twofac', changefreq: 'monthly', priority: '0.7' },
  { path: '/compare/2fas-vs-proton-authenticator-vs-twofac', changefreq: 'monthly', priority: '0.7' },
  ...
  { path: '/migrate/aegis-authenticator', changefreq: 'monthly', priority: '0.6' },
  { path: '/migrate/bitwarden', changefreq: 'monthly', priority: '0.6' },
  { path: '/migrate/proton-authenticator', changefreq: 'monthly', priority: '0.6' },
